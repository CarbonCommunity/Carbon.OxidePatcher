namespace Oxide.Patcher.Views
{
    partial class HookViewControl
    {
        ...
        private void InitializeComponent()
        {
			...
			this.beforesplit = new System.Windows.Forms.SplitContainer();
			this.aftersplit = new System.Windows.Forms.SplitContainer();
			this.detailsgroup.SuspendLayout();
			this.detailstable.SuspendLayout();
			this.buttonholder.SuspendLayout();
			this.aftertab.SuspendLayout();
			this.beforetab.SuspendLayout();
			this.tabview.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.beforesplit)).BeginInit();
			this.beforesplit.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.aftersplit)).BeginInit();
			this.aftersplit.SuspendLayout();
			this.SuspendLayout();
			// 
			// detailsgroup
			// 
			...
			// aftertab
			// 
			this.aftertab.AutoScroll = true;
			this.aftertab.Controls.Add(this.aftersplit);
			...
			this.aftertab.TabIndex = 4;
			this.aftertab.Text = "After";
			this.aftertab.UseVisualStyleBackColor = true;
			// 
			// beforetab
			// 
			this.beforetab.AutoScroll = true;
			this.beforetab.Controls.Add(this.beforesplit);
			...
			this.aftertab.ResumeLayout(false);
			this.beforetab.ResumeLayout(false);
			this.tabview.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.beforesplit)).EndInit();
			this.beforesplit.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.aftersplit)).EndInit();
			this.aftersplit.ResumeLayout(false);
        ...
        private System.Windows.Forms.SplitContainer aftersplit;
        private System.Windows.Forms.SplitContainer beforesplit;
    }
}
